  ...
  Widget _buildQuickStats() {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, userSnap) {
        ...
        final studentCount = users.where((d) => d['role'] == 'student').length;
        final adminCount = users.where((d) => d['role'] == 'admin').length;
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData) {
          ...
          present = docs.where((d) => d['status'] == 'present').length;
          absent = docs.where((d) => d['status'] == 'absent').length;
          if (totalMarked > 0) {
